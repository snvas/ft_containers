...
class map
{
	...
	*/
	 ...
	 * @return an iterator referring to the first node of the map(minimum value).
	*/
	iterator begin()
	{
	 ...
	 * @return an const_iterator pointing to the first node of the map(minimum value).
	*/
	...
	*/
	...
	ft::pair<iterator, bool> insert(const value_type &val)
	{
		...
		// Inserts the pari in the tree and returns an interator to its position
		this->_size += 1;
